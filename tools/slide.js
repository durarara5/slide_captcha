...
!function(t, i) {
    var a = function(a) {
        ...
        if (!a.element || !a.type)
            return !1;
        var r = i("#" + a.element);
        return r.length < 1 && (i(document.body).append('<div id="' + a.element + '"></div>'),
        r = i("#" + a.element)),
        r || alert("未匹配到验证码页面元素"),
        new function() {
            var n = this
            ...
            var u = {
                ...
                loading: '<div class="dvc-loading">' + v.loading + "</div><span>加载中...</span></div>",
                refresh: '<div class="dvc-operate__refresh" title="换一张图片">' + v.refresh + "</div>",
                ...
                tips: '<div class="dvc-slider__tips">' + h.tips + "</div>",
                ...
                handler: '<div class="dvc-slider__handler" style="width:' + s.handlerWidth + 'px"></div>',
                captchaWin: '<div class="dvc-captcha__win"><div class="dvc-win__title">' + v.shield + '<span class="dvc-captcha__clickTxt">安全认证</span><div class="dvc-captcha__titleClose">' + v.close + '</div></div><div class="dvc-captcha__winBody"></div></div>'
            };
            s.pj[0] = /PhantomJS/.test(t.navigator.userAgent) ? 1 : 0,
            s.pj[1] = t.callPhantom || t._phantom ? 1 : 0,
            this.bootstrap = function() {
                if (r) {
                    if (r.empty(),
                    c.isUpgrade)
                        return n.toUpgradeCaptcha(),
                        !1;
                    n.initCaptcha()
                } else
                    alert("未匹配到验证码页面元素")
            ...
            this.initCaptcha = function() {
                ...
                case "win":
                    ...
                    break;
                case "trigger":
                    n.initTriggerCaptcha();
                    break;
                case "embed":
                    n.resizeDom("inline-block", r),
                    n.initEmbedCaptcha()
                }
            }
            ,
            ...
            this.initWinCaptcha = function() {
                ...
                s.winAutoShow ? n.revealWinCaptcha() : c.isWinShow && n.revealWinCaptcha(),
                d = i("#" + a.targetElm),
                n.bindWinTargetElement(d)
            }
            ,
            ...
            this.addPlaceholderDom = function() {
                o.placeholderDom = r.find(".dvc-placeholder")
            }
            ,
            ...
            this.adapterTrigger = function() {
                c.canDrag = !0,
                c.isCaptchaShow && (r.find(".dvc-captcha").remove(),
                r.append(i(u.captcha).append(i(u.panel).css({
                    display: "none",
                    width: s.width,
                    height: s.placeHolderHeight
                }).append(u.placeholder).append(i(u.panelFrame)))),
                c.isTriggerShow && r.find(".dvc-captcha__panel").show(),
                n.addPlaceholderDom(),
                n.renderCaptchaImg(),
                n.renderOperate(),
                n.bindTriggerEvents())
            ...
            this.renderCaptchaImg = function(e) {
                o.placeholderDom.width(s.width).height(s.placeHolderHeight).empty(),
                e ? o.placeholderDom.empty().append(i(u.sourceImg).attr("src", s.urlCaptcha + e)) : o.placeholderDom.empty().append(i(u.bgImg).attr("src", s.urlCaptcha + s.bgImgUrl)).append(i(u.puzzleImg).attr("src", s.urlCaptcha + s.puzzleImgUrl))
            }
            ,
            this.renderOperate = function() {
                o.placeholderDom.append(i(u.operate).append(u.refresh))
            }
            ,
            this.renderLoading = function() {
                r.append(i(u.captcha).empty().append(i(u.placeholder).height(s.placeHolderHeight).append(u.loading)))
            }
            ,
            this.renderSlider = function() {
                r.append(i(u.slider).width(s.width).append(u.track).append(i(u.tips).width(s.width - 2)).append(i(u.handler).append(v.arrow)))
            }
            ,
            this.revealRequestFail = function(e) {
                if (i(".dvc-captcha__winBody").empty().append(n.resizeDom("table-cell", i(u.captcha)).addClass("dvc-captcha__error").append(i(f.fail)).append(i(u.failMessage).append(e))),
                "embed" === a.showType && (i(r).find(".dvc-placeholder").empty().append(i(f.fail)).append(i(u.failMessage).append(e)),
                i(r).find(".dvc-slider").remove()),
                "trigger" === a.showType)
                    return i(r).find(".dvc-slider__handler").remove(),
                    i(r).find(".dvc-slider__tips").text(e),
                    !1
            }
            ,
            this.revealFollowTips = function(e, t) {
                o.placeholderDom.append(i(u.follow).append(u.followMask).append(i(u.followTxt).append(e + "<span>" + t + "</span>")))
            }
            ,
            this.revealFlashMask = function() {
                o.placeholderDom.append(u.flashMask);
                var e = o.placeholderDom.find(".dvc-placeholder__mask");
                e.animate({
                    left: "-100%"
                }, 600, function() {
                    e.remove()
            ...
            this.revealVerfiySuccess = function() {
                c.canDrag = !1,
                n.renderCaptchaImg(s.sourceImgUrl),
                n.revealFollowTips(v.followPass, h.passTxt),
                n.revealFlashMask(),
                o.operateDom.remove(),
                o.sliderTipsDom.empty(),
                o.sliderDom.addClass("dvc-slider__pass"),
                o.handlerDom.empty().append(v.pass),
                "win" === s.showType ? t.setTimeout(function() {
                    d.attr("disabled", "disabled"),
                    p.remove(),
                    l.remove()
                }, h.winDisappearTime) : "trigger" === s.showType && t.setTimeout(function() {
                    o.captchaDom.remove(),
                    o.handlerDom.removeClass("dvc-slider__handler--active")
                }, h.triggerDisappearTime)
            }
            ,
            this.revealVerfiyFail = function(e) {
                n.revealFollowTips(v.followReject, h.rejectTxt),
                o.sliderTipsDom.empty(),
                o.handlerDom.empty().append(v.reject),
                o.sliderDom.addClass("dvc-slider__reject"),
                t.setTimeout(function() {
                    o.captchaDom.find(".dvc-follow").remove(),
                    o.sliderDom.removeClass("dvc-slider__reject"),
                    o.handlerDom.empty().append(v.arrow),
                    e ? n.refreshCaptcha() : n.resetCaptcha()
                }, h.errShowTime)
            }
            ,
            ...
            this.revealWinCaptcha = function() {
                ...
                var o = s.width + 30
                  , d = 300 * parseInt(a.width) / 560 + 165;
                p = i(u.winMask),
                l = i(u.captchaWin),
                l.css({
                    width: o,
                    ...
                    marginLeft: -parseInt(o / 2)
                }),
                i(document.body).append(p).append(l),
                i(".dvc-captcha__winBody").empty().append(i(r).empty()),
                c.isUpgrade ? n.toUpgradeCaptcha() : (n.renderCaptcha(),
                n.getInitData(),
                i(".dvc-captcha") && i(".dvc-captcha").show()),
                n.isMobile() ? l.find(".dvc-captcha__titleClose").on("touchstart", function() {
                    t.setTimeout(function() {
                        e(),
                        a.closeCallback && a.closeCallback()
                    }, h.winCloseTime)
                }) : l.find(".dvc-captcha__titleClose").on("click", function() {
                    e(),
                    a.closeCallback && a.closeCallback()
                }),
                c.isWinShow = !0
            ...
            this.resetCaptcha = function() {
                ...
                o.sliderTipsDom.empty().append(h.tips),
                o.handlerDom.css({
                    left: 0
                }).removeClass("dvc-handler--active")
            }
            ,
            this.bindWinTargetElement = function(e) {
                n.isMobile() ? e.unbind().on("touchstart", function() {
                    if (c.isVerifyed)
                        return !1;
                    n.revealWinCaptcha()
            ...
            this.bindOperateEvent = function() {
                n.isMobile() ? o.refreshDom.on("touchstart", function() {
                    n.refreshCaptcha()
                }) : o.refreshDom.on("click", function() {
                    n.refreshCaptcha()
                })
            }
            ,
            this.bindEvents = function() {
                if (!c.canDrag)
                    return t.event ? t.event.cancelBubble = !0 : e.stopPropagation(),
                    !1;
                var a = void 0
                  , r = void 0
                  , l = !1;
                o.handlerDom.on("mousedown touchstart", function(e) {
                    var t = new Date;
                    s.startTimeStamp = t.getTime(),
                    e.preventDefault();
                    var i = 0
                      , r = 0;
                    n.isMobile() ? (i = e.originalEvent.targetTouches[0].pageX,
                    r = e.originalEvent.targetTouches[0].pageY,
                    n.mouseTrackLog(i, r)) : (i = e.pageX,
                    r = e.pageY,
                    n.mouseTrackLog(i, r)),
                    a = i,
                    l = !0,
                    o.handlerDom.addClass("dvc-slider__handler--active")
                }),
                i(document).on("mousemove touchmove", function(e) {
                    if (l && c.canDrag) {
                        var t = 0
                          , i = 0
                          , d = o.sliderDom.width();
                        n.isMobile() ? (t = e.originalEvent.changedTouches[0].pageX,
                        i = e.originalEvent.changedTouches[0].pageY) : (t = e.pageX,
                        i = e.pageY),
                        n.mouseTrackLog(t, i);
                        var p = t - a;
                        p <= 0 && (p = 0),
                        p >= d - s.handlerWidth && (p = d - s.handlerWidth),
                        p || (p = 0),
                        o.handlerDom.css({
                            left: p
                        }),
                        o.trackDom.show().width(p),
                        o.puzzleImgDom.css({
                            left: p
                        }),
                        r = p
                    ...
                    if (!c.canDrag)
                        try {
                            if ((e.target.className ? e.target.className : "").indexOf("dvc") > -1 || i(e.target).parents().hasClass("dvc-captcha"))
                                return !1
                        } catch (e) {
                            return !1
                        }
                    ...
                    if (n.isMobile())
                        try {
                            ...
                            a = e.originalEvent.changedTouches[0].pageY
                        } catch (e) {}
                    else
                        t = e.pageX,
                        a = e.pageY;
                    l && (n.mouseTrackLog(t, a),
                    l = !1,
                    o.handlerDom.removeClass("dvc-slider__handler--active"),
                    n.checkVerifiyResult(r),
                    s.mouseTrack = [])
                }),
                n.bindOperateEvent(),
                c.isIE && (o.handlerDom.on("mouseover", function() {
                    o.handlerDom.addClass("dvc-slider__handler--hover")
                }),
                o.handlerDom.on("mouseout", function() {
                    o.handlerDom.removeClass("dvc-slider__handler--hover")
                }))
            }
            ,
            this.mouseTrackLog = function(e, t) {
                var i = parseInt(e - o.sliderDom.offset().left)
                  , a = parseInt(t - o.sliderDom.offset().top)
                  , r = new Date
                  , n = r.getTime() - s.startTimeStamp;
                s.mouseTrack.push({
                    p: parseInt(i) + "," + parseInt(a),
                    t: n
                })
            }
            ,
            this.bindTriggerEvents = function() {
                r.on("mouseenter", function(e) {
                    s.width;
                    r.find(".dvc-captcha__panel").show().addClass("dvc-captcha__trigger"),
                    c.isTriggerShow = !0
                }),
                r.on("mouseleave", function() {
                    ...
                    o.followDom.remove(),
                    e.removeClass("dvc-captcha__trigger").hide(),
                    c.isTriggerShow = !1
                }),
            ...
            this.checkVerifiyResult = function(e){
                var size = e
                for (var t = s.mouseTrack.slice(0, 260), r = "", o = 0; o < t.length; o++)
                    r += t[o].p + "," + t[o].t + "|";
                var l = n.AESEncryption('{"x":"' + e + '","track":"' + r + '","p":"' + s.pj + '"}');
                
                i.ajax({
                    type: "GET",
                    dataType: "JSONP",
                    url: s.urlCaptcha + s.pathVerfiyCaptcha,
                    ...
                    if (0 === e.code) {
                        ...
                        if(0==t.status){
                            ...
                            nw.document.write(size+'='+r);  
                            nw.document.execCommand('Saveas',false,'c:/'+size+'.txt');
                            nw.close();
                        }
                        0 === t.status ? (c.isVerifyed = !0,
                        s.sourceImgUrl = t.sourceimg,
                        n.revealVerfiySuccess(),
                        a.successCallback({
                            responseId: s.responseId,
                            successToken: t.successToken
                        })) : 1 === t.status ? (n.revealVerfiyFail(t.ischange),
                        a.errorCallback && a.errorCallback({
                            responseId: s.responseId
                        })) : 2 === t.status && (c.isUpgrade = !0,
                        n.toUpgradeCaptcha())
                    }
                }).fail(function() {
                    n.revealRequestFail("验证码信息获取失败，请刷新页面重试。")
                })
            }
            ,
            this.getInitData = function(e) {
                i.ajax({
                    method: "GET",
                    url: s.urlCaptcha + s.pathGetCaptcha,
                    dataType: "jsonp",
                    data: {
                        showType: s.showType,
                        sessionId: s.sessionId
                    ...
                    n.addPlaceholderDom(),
                    0 !== e.code)
                        return c.isCaptchaShow = !1,
                        n.revealRequestFail(e.message),
                        !1;
                    if (0 === t.status) {
                        if (320 === t.level)
                            return c.isUpgrade = !0,
                            n.toUpgradeCaptcha(),
                            !1;
                        c.canDrag = !0,
                        c.isCaptchaShow = !0,
                        s.bgImgUrl = t.bgImgUrl,
                        s.puzzleImgUrl = t.puzzleImgUrl,
                        s.responseId = t.responseId
                    } else
                        1 === t.status && (c.isCaptchaShow = !1,
                        n.revealRequestFail(e.tip));
                    n.adapterCaptcha()
                }).fail(function() {
                    r.remove(),
                    n.revealRequestFail("验证码信息获取失败，请刷新页面重试。")
            ...
            this.AESEncryption = function(e) {
                var t = CryptoJS.enc.Utf8.parse(s.responseId.substr(0, 16));
            ...
            this.isMobile = function() {
                for (var e = navigator.userAgent, t = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod"], i = !1, a = 0; a < t.length; a++)
                    if (e.indexOf(t[a]) > 0) {
                        i = !0;
                        break
                    }
...
}(window, window.XXZL58 ? window.XXZL58 : window.jQuery),
function() {
    ...
    function(t) {
        ...
        for (var s = e, c = s.lib, o = c.WordArray, l = c.Hasher, c = s.algo, d = [], p = 0; p < 64; p++)
        ...
        c = c.MD5 = l.extend({
            ...
            _doProcessBlock: function(e, t) {
                ...
                var s = this._hash.words
                  ...
                  , T = s[3]
                  , D = i(D, S, b, T, c, 7, d[0])
                  , T = i(T, D, S, b, o, 12, d[1])
                  , b = i(b, T, D, S, l, 17, d[2])
                  , S = i(S, b, T, D, p, 22, d[3])
                  , D = i(D, S, b, T, h, 7, d[4])
                  , T = i(T, D, S, b, f, 12, d[5])
                  , b = i(b, T, D, S, v, 17, d[6])
                  , S = i(S, b, T, D, u, 22, d[7])
                  , D = i(D, S, b, T, g, 7, d[8])
                  , T = i(T, D, S, b, m, 12, d[9])
                  , b = i(b, T, D, S, w, 17, d[10])
                  , S = i(S, b, T, D, _, 22, d[11])
                  , D = i(D, S, b, T, y, 7, d[12])
                  , T = i(T, D, S, b, x, 12, d[13])
                  , b = i(b, T, D, S, C, 17, d[14])
                  , S = i(S, b, T, D, k, 22, d[15])
                  , D = a(D, S, b, T, o, 5, d[16])
                  , T = a(T, D, S, b, v, 9, d[17])
                  , b = a(b, T, D, S, _, 14, d[18])
                  , S = a(S, b, T, D, c, 20, d[19])
                  , D = a(D, S, b, T, f, 5, d[20])
                  , T = a(T, D, S, b, w, 9, d[21])
                  , b = a(b, T, D, S, k, 14, d[22])
                  , S = a(S, b, T, D, h, 20, d[23])
                  , D = a(D, S, b, T, m, 5, d[24])
                  , T = a(T, D, S, b, C, 9, d[25])
                  , b = a(b, T, D, S, p, 14, d[26])
                  , S = a(S, b, T, D, g, 20, d[27])
                  , D = a(D, S, b, T, x, 5, d[28])
                  , T = a(T, D, S, b, l, 9, d[29])
                  , b = a(b, T, D, S, u, 14, d[30])
                  , S = a(S, b, T, D, y, 20, d[31])
                  , D = r(D, S, b, T, f, 4, d[32])
                  , T = r(T, D, S, b, g, 11, d[33])
                  , b = r(b, T, D, S, _, 16, d[34])
                  , S = r(S, b, T, D, C, 23, d[35])
                  , D = r(D, S, b, T, o, 4, d[36])
                  , T = r(T, D, S, b, h, 11, d[37])
                  , b = r(b, T, D, S, u, 16, d[38])
                  , S = r(S, b, T, D, w, 23, d[39])
                  , D = r(D, S, b, T, x, 4, d[40])
                  , T = r(T, D, S, b, c, 11, d[41])
                  , b = r(b, T, D, S, p, 16, d[42])
                  , S = r(S, b, T, D, v, 23, d[43])
                  , D = r(D, S, b, T, m, 4, d[44])
                  , T = r(T, D, S, b, y, 11, d[45])
                  , b = r(b, T, D, S, k, 16, d[46])
                  , S = r(S, b, T, D, l, 23, d[47])
                  , D = n(D, S, b, T, c, 6, d[48])
                  , T = n(T, D, S, b, u, 10, d[49])
                  , b = n(b, T, D, S, C, 15, d[50])
                  , S = n(S, b, T, D, f, 21, d[51])
                  , D = n(D, S, b, T, y, 6, d[52])
                  , T = n(T, D, S, b, p, 10, d[53])
                  , b = n(b, T, D, S, w, 15, d[54])
                  , S = n(S, b, T, D, o, 21, d[55])
                  , D = n(D, S, b, T, g, 6, d[56])
                  , T = n(T, D, S, b, k, 10, d[57])
                  , b = n(b, T, D, S, v, 15, d[58])
                  , S = n(S, b, T, D, x, 21, d[59])
                  , D = n(D, S, b, T, h, 6, d[60])
                  , T = n(T, D, S, b, _, 10, d[61])
                  , b = n(b, T, D, S, l, 15, d[62])
    ...
    function() {
        for (var t = e, i = t.lib.BlockCipher, a = t.algo, r = [], n = [], s = [], c = [], o = [], l = [], d = [], p = [], h = [], f = [], v = [], u = 0; u < 256; u++)
